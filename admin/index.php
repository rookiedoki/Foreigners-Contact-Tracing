          ...
          <div class="col-xl-3 col-sm-6 mb-3">
            <div class="card bg-danger text-white o-hidden h-100">
              <div class="card-body">
                ...
                <h4><b id="total_inactive_users"></b> Positive</h4>
              </div>
            </div>
          </div>
          <div class="col-xl-3 col-sm-6 mb-3">
            <div class="card bg-success text-white o-hidden h-100">
              <div class="card-body">
                ...
                <h4><b id="total_active_users"></b> Negative</h4>
              </div>
            </div>
          </div>
          <div class="col-xl-3 col-sm-6 mb-3">
      ...
      <div class="col-lg-8">
        <div class="card mb-3">
          <div class="card-header">
            ...
            Monthly Registered Foreigners</div>
          <div class="card-body">
      ...
      <div class="col-lg-4">
        <div class="card mb-3">
          <div class="card-header">
            ...
            Foreigners Gender Distribution</div>
          <div class="card-body">
